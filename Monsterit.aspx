<%@ Page Title="" Language="C#" MasterPageFile="~/TopBar.master" AutoEventWireup="true" CodeFile="Monsterit.aspx.cs" Inherits="Monsterit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td>
                <h1>Haku:</h1>
                <h2>Taso: <asp:TextBox ID="txtboxMonsterinTaso" runat="server"></asp:TextBox>
                <h2>Minimi Osumapisteet: <asp:TextBox ID="txtboxMinHP" runat="server"></asp:TextBox>
                    Maksimi osumapisteet: <asp:TextBox ID="txtboxMaksHP" runat="server"></asp:TextBox></h2>
                <h2>Sana Haku: <asp:TextBox ID="txtboxSanaHaku" runat="server"></asp:TextBox></h2>
                <h2>Nimi: <asp:CheckBox ID="checkNimi" runat="server" />
                    Kyvyt: <asp:CheckBox ID="checkKyvyt" runat="server" />
                    Rooli: <asp:CheckBox ID="checkRooli" runat="server" />
                    Tyyppi: <asp:CheckBox ID="checkTyyppi" runat="server" />
                    Ryhmittymä: <asp:CheckBox ID="checkRyhmittyma" runat="server" /></h2>
                
                <asp:Button ID="btnHaku" runat="server" Text="Hae" OnClick="getMonsterit"/>
    ...
    <asp:Repeater ID="RepeaterMonsters" runat="server" OnItemCommand="RepeaterMonsters_ItemCommand">
            <ItemTemplate>
                <td><asp:Button ID="btnLisaaEncountteriin" runat="server" Text=<%# DataBinder.Eval(Container.DataItem, "name") %>/></td>
                <div
                   ...
                   <!-- REPEATER VÄLI -->
                    ...
                    <asp:Repeater ID="RepeaterAttacks" runat="server" EnableViewState="false" DataMember="Attack" DataSource='<%# DataBinder.Eval(Container.DataItem, "Attackit") %>'>
                        <ItemTemplate>
