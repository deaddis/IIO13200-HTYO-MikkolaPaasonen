<%@ Page Title="Lisää Encounteri" Language="C#" MasterPageFile="~/TopBar.master" AutoEventWireup="true" CodeFile="LisaaEncounter.aspx.cs" Inherits="LisaaEncounter" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <h1>Uusi kohtaaminen:</h1>
    <h3>Nimi: </h3> <asp:TextBox ID="txtboxNimi" runat="server"></asp:TextBox>
    <h3>Taso: </h3> <asp:TextBox ID="txtboxTaso" runat="server"></asp:TextBox>
    <h3>Kuvaus: </h3> <asp:TextBox ID="txtboxKuvaus" runat="server"></asp:TextBox>

    <h3>Monsterit: <asp:Button ID="btnLataaMonsterit" runat="server" Text="Lataa Monsterit" OnClick="btnLataaMonsterit_Click"/> </h3>
    <br />
    <asp:Repeater ID="RepeaterMonsterit" runat="server" OnItemCommand="RepeaterMonsterit_ItemCommand1">
        <ItemTemplate>

          <td>  <asp:Button ID="Button1" Text="Poista" runat="server" ToolTip=<%# DataBinder.Eval(Container.DataItem, "name") %> /></td>
<div
    ...
    <asp:Button ID="btnTallenna" runat="server" Text="Tallenna kohtaaminen tietokantaan" OnClick="btnTallenna_Click" />
